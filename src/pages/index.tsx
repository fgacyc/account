...
export default function Home() {
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-[#f1f2f4] px-10 py-8 transition-colors duration-150 ease-in-out dark:bg-[#241F20]">
        <div className="flex w-full flex-grow flex-row justify-between overflow-hidden rounded-xl bg-white shadow-xl dark:bg-[#505050]">
          <div className="relative flex w-full max-w-[320px] flex-grow flex-col justify-between bg-[#3b3b3b] p-5 dark:bg-[#00EDC2]">
